// Enhanced by AI on 2025-08-16T22:57:22.149Z
// Section: hero
// Category: hero
        ...
        <div className="relative pt-20 pb-16 sm:pt-24 sm:pb-20 lg:pt-32 lg:pb-28">
          ...
          <div className="text-center max-w-4xl mx-auto">
            ...
            <p className="text-lg sm:text-xl text-muted-foreground max-w-2xl mx-auto mb-8 leading-relaxed">
              Projeq is a powerful SaaS platform that helps small and medium businesses, teams, and professionals
              manage their projects more efficiently. With cutting-edge tools and templates, you can turn your ideas
